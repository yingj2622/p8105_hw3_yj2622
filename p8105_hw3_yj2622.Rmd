...
Next, I make plots of `year` vs average `tmax` oberved in differnt stations in January and July separately.
...
Below are interpretions of the plots:
...
* There are outliers of the average maximum temperature in both January and July. For example, in July, 1988, the average of maximum temperature recorded by one station is very low compared to others. And in January, 2005, there is also a very low average maximum temperature recordered by one station.
