...
* Convert `id` into factor and convert `tmin` and `tmax` into number;
...
It can be seen that the most common values of snowfall is 0 mm. That's because most of time there is no snowfall in Ny state.
