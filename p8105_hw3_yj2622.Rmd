...
* The dataset provides information on "activity counts" of the man in days in five weeks. The counting starts at the midnight of each day and "activity counts" in each observations in each days are given. Also, information about which week a certain day belongs to, day of the week and whether that day is a weekday or weekend can be obtained.

Then I aggregate accross minutes to create a total activity variable for each day and create a table.
